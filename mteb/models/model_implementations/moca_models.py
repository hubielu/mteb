            ...
            for i in range(batch_size):
                ...
                if has_image:
                    ...
                    if text:
                        ...
                        texts.append(_IMAGE_TOKEN + _IMAGE_PROMPT + "\n")
                else:
                    texts.append(text)
...
moca_training_datasets = set(
    ...
    # none of these are currently registered as mteb task names
)
...
moca_qwen25vl_3b = ModelMeta(
    ...
    public_training_data="https://huggingface.co/collections/moca-embed/moca-datasets",
...
moca_qwen25vl_7b = ModelMeta(
    loader=MoCaWrapper,
    loader_kwargs=dict(processor_name="Qwen/Qwen2.5-VL-7B-Instruct"),
    ...
    release_date="2025-06-29",
    modalities=["image", "text"],
    n_parameters=8_294_263_808,
    memory_usage_mb=15820,
    embed_dim=3584,
    license="mit",
    max_tokens=32768,
